        ...
        if x2 > x1 and y2 > y1: #direction is diagonal
            for i in range(3):
                ...
                if i < 2:
                    ...
                    if 0<=nx1<N and 0<=ny1<N and 0<=nx2<N and 0<=ny2<N and 0<=nx1+1<N and 0<=ny1+1<N:
                        if graph[nx1][ny1] != "X" and graph[nx2][ny2] != "X" and graph[nx1+1][ny1] != "X" and graph[nx1][ny1+1] != "X":
                            graph[nx2][ny2] = graph[x2][y2] + 1
                            q.append([[nx1,ny1],[nx2,ny2]])
